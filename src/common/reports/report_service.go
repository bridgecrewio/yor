...
func noColorCheck (noColor bool) {
        if noColor {
                colorReset  = ""
                colorGreen  = ""
                colorYellow = ""
...
func (r *ReportService) PrintToStdout(noColor bool) {
        noColorCheck(noColor)
	PrintBanner()
	...
	if r.report.Summary.NewResources > 0 {
		r.printNewResourcesToStdout(noColor)
	}
	fmt.Println()
	if r.report.Summary.UpdatedResources > 0 {
		r.printUpdatedResourcesToStdout(noColor)
	}
}
...
func (r *ReportService) printUpdatedResourcesToStdout(noColor bool) {
...
func (r *ReportService) printNewResourcesToStdout(noColor bool) {
