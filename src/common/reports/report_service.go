...
func colorCheck (colorBool bool) *colorStruct {
...
func (r *ReportService) PrintToStdout(colorBool bool) {
        colors := colorCheck(colorBool)
	PrintBanner(colorBool)
	...
	if r.report.Summary.NewResources > 0 {
		r.printNewResourcesToStdout(colorBool)
	}
	fmt.Println()
	if r.report.Summary.UpdatedResources > 0 {
		r.printUpdatedResourcesToStdout(colorBool)
	}
}

func PrintBanner(colorBool bool) {
        colors := colorCheck(colorBool)
	fmt.Printf("%v%vv%v\n", common.YorLogo, colors.Purple, common.Version)
}

func (r *ReportService) printUpdatedResourcesToStdout(colorBool bool) {
        colors := colorCheck(colorBool)
...
func (r *ReportService) printNewResourcesToStdout(colorBool bool) {
        colors := colorCheck(colorBool)
