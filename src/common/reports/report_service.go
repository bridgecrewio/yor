...
func (r *ReportService) PrintToStdout(noColorBool bool) {
        colors := noColorCheck(noColorBool)
	PrintBanner(noColorBool)
	...
	if r.report.Summary.NewResources > 0 {
		r.printNewResourcesToStdout(noColorBool)
	}
	fmt.Println()
	if r.report.Summary.UpdatedResources > 0 {
		r.printUpdatedResourcesToStdout(noColorBool)
	}
}

func PrintBanner(noColorBool bool) {
        colors := noColorCheck(noColorBool)
	fmt.Printf("%v%vv%v\n", common.YorLogo, colors.Purple, common.Version)
}

func (r *ReportService) printUpdatedResourcesToStdout(noColorBool bool) {
        colors := noColorCheck(noColorBool)
...
func (r *ReportService) printNewResourcesToStdout(noColorBool bool) {
        colors := noColorCheck(noColorBool)
