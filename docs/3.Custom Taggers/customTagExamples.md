...
3. [Using YAML configuration files](../Custom_tagger_YAML.md#custom-tagger-using-yaml--configuration-files)
4. [Using CLI commands](../Custom_tagger_YAML.md#custom-tagger-using-yaml--configuration-files)
