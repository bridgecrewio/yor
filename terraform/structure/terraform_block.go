...
func (b *TerraformBlock) AddHclSyntaxBlock(hclSyntaxBlock *hclsyntax.Block) {
	...
	b.IsTaggable = hclSyntaxBlock.Type == "resource" && isResourceTypeTaggable(hclSyntaxBlock.Labels[0])
}

func isResourceTypeTaggable(resourceType string) bool {
	// TODO: query the relevant terraform provider for AWS / GOOGLE / AZURERM
