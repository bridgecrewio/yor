...
type TagChangeAccumulator struct {
	ScannedBlocks      []common.IBlock
	NewBlockTraces     []common.IBlock
	UpdatedBlockTraces []common.IBlock
}
...
func (a *TagChangeAccumulator) AccumulateChanges(block common.IBlock) {
...
func (a *TagChangeAccumulator) GetBlockChanges() ([]common.IBlock, []common.IBlock) {
	return a.NewBlockTraces, a.UpdatedBlockTraces
}
func (a *TagChangeAccumulator) GetScannedBlocks() []common.IBlock {
